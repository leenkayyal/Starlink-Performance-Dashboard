...
<div style="display:flex; justify-content:space-between; align-items:flex-start; gap:20px;">
    <div>
        <div class="main-title">Starlink Performance Forecast System</div>
        <div class="sub-title">University Network Intelligence Dashboard for monitoring, forecasting, and operational decision support</div>
    </div>
    <div style="text-align:right;">
        <div style="font-weight:700;">GUtech AI Thesis Prototype</div>
        <div style="color:#9aa4b2;">Starlink-focused deployment interface</div>
    </div>
</div>
""", unsafe_allow_html=True)
