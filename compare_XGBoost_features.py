...
df_old = pd.read_csv("Cleaned/starlink_forecast.csv")

# After Feature Engineering
df_new = pd.read_csv("Cleaned/starlink_forecast_v2.csv")
...
plt.savefig("XGBoost: Before vs After Feature Engineering")
plt.show()